...
import { FlowStatusModuleBranchChosen } from './FlowStatusModuleBranchChosen.ts';
...
export class FlowStatusModule {
    ...
    'branchChosen'?: FlowStatusModuleBranchChosen;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "branchChosen",
            "baseName": "branch_chosen",
            "type": "FlowStatusModuleBranchChosen",
            "format": ""
        }    ];
