...
export class WorkspaceApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param inlineObject4 
     */
    public async existsUsername(inlineObject4: InlineObject4, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'inlineObject4' is not null or undefined
        if (inlineObject4 === null || inlineObject4 === undefined) {
            throw new RequiredError("WorkspaceApi", "existsUsername", "inlineObject4");
        }


        // Path Params
        const localVarPath = '/workspaces/exists_username';
     ...
     * @param inlineObject3 
     */
    public async existsWorkspace(inlineObject3: InlineObject3, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'inlineObject3' is not null or undefined
        if (inlineObject3 === null || inlineObject3 === undefined) {
            throw new RequiredError("WorkspaceApi", "existsWorkspace", "inlineObject3");
        }


        // Path Params
        const localVarPath = '/workspaces/exists';
...
export class WorkspaceApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to existsUsername
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async existsUsername(response: ResponseContext): Promise<boolean > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to existsWorkspace
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async existsWorkspace(response: ResponseContext): Promise<boolean > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: boolean = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
