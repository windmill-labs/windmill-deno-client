...
export class UserApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async loginWithOauth(clientName: string, inlineObject10: InlineObject10, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'clientName' is not null or undefined
        if (clientName === null || clientName === undefined) {
            throw new RequiredError("UserApi", "loginWithOauth", "clientName");
        }


        // verify required parameter 'inlineObject10' is not null or undefined
        if (inlineObject10 === null || inlineObject10 === undefined) {
            throw new RequiredError("UserApi", "loginWithOauth", "inlineObject10");
        }


        // Path Params
        const localVarPath = '/oauth/login_callback/{client_name}'
...
export class UserApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to loginWithOauth
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async loginWithOauth(response: ResponseContext): Promise<string > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: string = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
