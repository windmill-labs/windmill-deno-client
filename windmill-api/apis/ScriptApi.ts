...
export class ScriptApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createScript(workspace: string, inlineObject15: InlineObject15, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (inlineObject15 === null || inlineObject15 === undefined) {
            throw new RequiredError("ScriptApi", "createScript", "inlineObject15");
        }
     ...
     * @param path 
     */
    public async existsScriptByPath(workspace: string, path: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'workspace' is not null or undefined
        if (workspace === null || workspace === undefined) {
            throw new RequiredError("ScriptApi", "existsScriptByPath", "workspace");
        }


        // verify required parameter 'path' is not null or undefined
        if (path === null || path === undefined) {
            throw new RequiredError("ScriptApi", "existsScriptByPath", "path");
        }


        // Path Params
        const localVarPath = '/w/{workspace}/scripts/exists/p/{path}'
            .replace('{' + 'workspace' + '}', encodeURIComponent(String(workspace)))
            .replace('{' + 'path' + '}', encodeURIComponent(String(path)));
     ...
     * @param path 
     */
    public async rawScriptByHash(workspace: string, path: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'workspace' is not null or undefined
        if (workspace === null || workspace === undefined) {
            throw new RequiredError("ScriptApi", "rawScriptByHash", "workspace");
        }


        // verify required parameter 'path' is not null or undefined
        if (path === null || path === undefined) {
            throw new RequiredError("ScriptApi", "rawScriptByHash", "path");
        }


        // Path Params
        const localVarPath = '/w/{workspace}/scripts/raw/h/{path}'
            .replace('{' + 'workspace' + '}', encodeURIComponent(String(workspace)))
            .replace('{' + 'path' + '}', encodeURIComponent(String(path)));
     ...
     * @param path 
     */
    public async rawScriptByPath(workspace: string, path: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'workspace' is not null or undefined
        if (workspace === null || workspace === undefined) {
            throw new RequiredError("ScriptApi", "rawScriptByPath", "workspace");
        }


        // verify required parameter 'path' is not null or undefined
        if (path === null || path === undefined) {
            throw new RequiredError("ScriptApi", "rawScriptByPath", "path");
        }


        // Path Params
        const localVarPath = '/w/{workspace}/scripts/raw/p/{path}'
            .replace('{' + 'workspace' + '}', encodeURIComponent(String(workspace)))
            .replace('{' + 'path' + '}', encodeURIComponent(String(path)));
...
export class ScriptApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to existsScriptByPath
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async existsScriptByPath(response: ResponseContext): Promise<boolean > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getScriptDeploymentStatus(response: ResponseContext): Promise<InlineResponse2005 > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listHubScripts(response: ResponseContext): Promise<InlineResponse2002 > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to rawScriptByHash
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async rawScriptByHash(response: ResponseContext): Promise<string > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: string = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to rawScriptByPath
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async rawScriptByPath(response: ResponseContext): Promise<string > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: string = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
